                    ...
                    SliverToBoxAdapter(
                      child: Padding(
                        ...
                        child: _SectionHeader(
                          ...
                          label: '${l10n.socialFriends} (${friends.length})',
                          cs: cs,
                        ),
                      ),
                    ),
...
class _FriendCard extends StatelessWidget {
  ...
  Future<void> _confirmRemove(
    ...
    if (confirmed == true) {
      await socialService.removeFriend(uid);
    }
  }
}
...
class _SearchResultCardState extends State<_SearchResultCard> {
  ...
  String get _uid {
    return widget.user['uid'] as String? ?? widget.user['id'] as String? ?? '';
  }
            ...
            if (_loading || _acting)
              ...
              Container(
                ...
                OutlinedButton(
                  onPressed: () {
                    _act(() {
                      return socialService.cancelFriendRequest(
                        _status!['requestId'],
                      );
                    });
                  },
