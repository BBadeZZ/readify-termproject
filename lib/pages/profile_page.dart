      ...
      body: _loading
        ...
        children: [
                  ...
                  children: [
                    if (favoriteGenre != '—')
                      _ProfileBadge(
                        ...
                        text: l10n.profileFavoriteGenre(favoriteGenre),
                      ),
                    if (streak > 0)
                      _ProfileBadge(
                        emoji: '🔥',
                        text: '$streak ${l10n.profileStreakLabel}',
                      ),
                  ],
                ),
              ],
          ...
          GridView.count(
            ...
            mainAxisSpacing: 10,
            crossAxisSpacing: 10,
            childAspectRatio: MediaQuery.of(context).size.width < 380 ? 2.4 : 1.25,
            children: [
              StatCard(
                label: l10n.profileTotalBooks,
                value: '$totalBooks',
              ...
              StatCard(
                ...
                color: AppColors.favoritesContainer,
                iconColor: Colors.pink,
              ),
              StatCard(
                label: l10n.profilePagesRead,
                value: '$totalPages',
            ...
            GridView.count(
              ...
              children: [
                StatCard(
                  ...
                  iconColor: AppColors.sessionPurple,
                ),
                StatCard(
                ...
                StatCard(
                  label: l10n.profilePagesInSessions,
                  value: '$sessionPages',
...
class _AchievementsRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final maxSessionPages = sessions.isEmpty
        ? 0
        : sessions.map((s) => s.pagesRead).reduce((a, b) => a > b ? a : b);
    final maxSessionMin = sessions.isEmpty
        ? 0
        : sessions.map((s) => s.durationMinutes).reduce((a, b) => a > b ? a : b);
    ...
    final badges = [
      (
      emoji: '📚',
      label: l10n.achieveFirstBook,
      unlocked: books.isNotEmpty,
      ),
      (
      emoji: '🎯',
      label: l10n.achieve5Books,
      unlocked: books.length >= 5,
      ),
      (
      emoji: '🏆',
      label: l10n.achieve10Books,
      unlocked: books.length >= 10,
      ),
      (
      emoji: '✅',
      label: l10n.achieveFirstFinish,
      unlocked: finished >= 1,
      ),
      (
      emoji: '❤️',
      label: l10n.achieveCollector,
      unlocked: favorites >= 5,
      ),
      (
      emoji: '💯',
      label: l10n.achieve100Pages,
      unlocked: totalPages >= 100,
      ),
      (
      emoji: '📖',
      label: l10n.achieve1000Pages,
      unlocked: totalPages >= 1000,
      ),
      (
      emoji: '⚡',
      label: l10n.achieveSpeedReader,
      unlocked: maxSessionPages >= 50,
      ),
      (
      emoji: '⏱️',
      label: l10n.achieveMarathoner,
      unlocked: maxSessionMin >= 60,
      ),
      (
      emoji: '🔥',
      label: l10n.achieve7DayStreak,
      unlocked: streak >= 7,
      ),
      (
      emoji: '⭐',
      label: l10n.achieveCritic,
      unlocked: hasHighRating,
      ),
    ];
